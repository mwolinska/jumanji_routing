...
@hydra.main(config_path=str("configs"), config_name="config.yaml")
...
if __name__ == "__main__":
    import timeit
    num_runs = 2  # Number of times to run the code
    total_time = timeit.timeit(train, number=num_runs)
    avg_time = total_time / num_runs

    print(f"Total time taken for {num_runs} runs: {total_time:.2f} seconds")
    print(f"Average time taken per run: {avg_time:.2f} seconds")